...
class AnnotationShow extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <div className="sr-only">Show Annotation Form</div>
                <div className="sr-only">{annotation.annotation_body}</div>
                <div className="annotation-whole-container">
                    ...
                    <div className = 'vote-buttons'>
                        <div className="sr-only">Upvote Annotation</div>
                        <button onClick={() => this.props.upvoteAnnotation(annotation.id)} className="upvote"><i className="fas fa-thumbs-up"></i></button>
                        ...
                        <div className="sr-only">Downvote Annotation</div>
                        <button onClick={() => this.props.downvoteAnnotation(annotation.id)} className="downvote"><i className="fas fa-thumbs-down"></i></button>
