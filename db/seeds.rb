...
Track3.save!
Annotation3 = Track3.annotations.create(body: "father was a black rocket scientist in the reagan era", start_index: 0, end_index: 10, annotator_id: Demouser.id)
Track3.save!
...
Track4.save!
Annotation4 = Track4.annotations.create(body: "natural/artificial binary", start_index: 0, end_index: 10, annotator_id: Demouser.id)
Track4.save!
...
Track6.save!
Annotation6 = Track6.annotations.create(body: "the quotidien nature of animal vs. human cruelty", start_index: 0, end_index: 10, annotator_id: Demouser.id)
Track6.save!
...
Track7.save!
Annotation7 = Track7.annotations.create(body: "metamorphosis/disease vectors", start_index: 0, end_index: 10, annotator_id: Demouser.id)
Track7.save!
...
Track8.save!
Annotation8 = Track8.annotations.create(body: "racism is alive and well", start_index: 0, end_index: 10, annotator_id: Demouser.id)
Track8.save!