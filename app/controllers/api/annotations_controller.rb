class Api::AnnotationsController < ApplicationController
    ...
    def vote(direction)
        @annotation = Annotation.find(params[:id])
        @vote = Vote.find_by_voteable(@annotation, current_user.id)
        ...
        if @vote    # if there exists a vote
            ...
            @annotation.votes.create!(voter_id: current_user.id, value: direction)  # make a vote with the current user's id
